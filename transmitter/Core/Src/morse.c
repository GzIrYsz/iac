...
void short_beep(ACT_GPIO_OUT* act_out) {
	HAL_GPIO_WritePin(act_out->gpio_act, act_out->pin_act, GPIO_PIN_SET);
	HAL_Delay(SHORT_BEEP_LENGTH);
	HAL_GPIO_WritePin(act_out->gpio_act, act_out->pin_act, GPIO_PIN_RESET);
	HAL_Delay(SHORT_BEEP_LENGTH);
}

void long_beep(ACT_GPIO_OUT* act_out) {
	HAL_GPIO_WritePin(act_out->gpio_act, act_out->pin_act, GPIO_PIN_SET);
